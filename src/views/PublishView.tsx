  ...
  return (
    <div className="view-stack publish-view">
      ...
      <section className="publish-checks">
        <article><Check size={16} /><div><strong>{publicEssays} 篇公开随笔</strong><small>草稿与归档内容不会进入快照</small></div></article>
        ...
        <article><Check size={16} /><div><strong>{publicMedia} 个公开媒体衍生文件</strong><small>原始图片、视频和本地路径不会发布</small></div></article>
